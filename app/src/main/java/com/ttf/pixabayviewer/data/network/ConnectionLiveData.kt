...
class ConnectionLiveData(
    ...
    private fun getConnectivityLollipopManagerCallback(): NetworkCallback {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
    ...
    private fun getConnectivityMarshmallowManagerCallback(): NetworkCallback {
        connectivityManagerCallback = object : NetworkCallback() {
    ...
    private fun updateConnection() {
        postValue(networkCheck.isInternetAvailable())
    }
}